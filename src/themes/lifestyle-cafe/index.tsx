...
export default function LifestyleCafeTheme({ restaurant, categories, openingHours, restaurantId, publicAccess }: ThemeProps) {
  ...
  return (
    <div className={`min-h-screen ${t.bg} ${t.text} pb-24 font-sans antialiased selection:bg-rose-200/40 sm:pb-0`}>
      ...
      <LifestyleStickyReserveCTA theme={t} enabled={publicAccess.reservationsEnabled} />
    </div>
  )
}
