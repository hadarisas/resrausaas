...
export default function MinimalTheme({ restaurant, categories, openingHours, restaurantId, publicAccess }: ThemeProps) {
  ...
  return (
    <div className={`min-h-screen ${t.bg} ${t.text} pb-24 font-sans antialiased sm:pb-0`}>
      ...
      <MinimalStickyReserveCTA theme={t} enabled={publicAccess.reservationsEnabled} />
    </div>
  )
}
